"""
Leaf Disease Detection Streamlit App
Interactive web interface for plant disease classification using trained CNN models.
"""
...
def main():
    ...
    st.sidebar.markdown("---")
    st.sidebar.markdown(
        "**About**: This app uses a CNN trained on the PlantVillage dataset to classify plant diseases."
    )
    st.sidebar.markdown(
        "**Dataset**: [PlantVillage](https://www.kaggle.com/datasets/emmarex/plantdisease) | ~50K images, 15 classes"
    )
    ...
    # Main UI: Tabs for upload and demo
